...
export async function getAssets(): Promise<Asset[]> {
  ...
  return assets.map((asset: any) => ({
    ...
    tangibleFields: asset.tangible_asset_fields && asset.tangible_asset_fields[0] ? {
    ...
    intangibleFields: asset.intangible_asset_fields && asset.intangible_asset_fields[0] ? {
